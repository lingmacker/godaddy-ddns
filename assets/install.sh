...
if [ "$1" == "" ]; then
    ...
    curl https://raw.githubusercontent.com/lingmacker/godaddy-ddns/master/assets/godaddyddns -o /usr/local/bin/godaddyddns
else
    # cp $basedir/godaddyddns /usr/local/bin/godaddyddns
    curl https://raw.githubusercontent.com/lingmacker/godaddy-ddns/$1/assets/godaddyddns -o /usr/local/bin/godaddyddns
fi
